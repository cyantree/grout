...
class CheckboxContent extends Content
{
    ...
    public function render($mode)
    {
        ...
        $c = '<input id="' . $this->name . '" type="checkbox" name="' . $this->name . '" value="' . StringTools::escapeHtml($this->value) . '"' . $attributes . ' /><label for="' . $this->name . '">' . StringTools::escapeHtml($this->label) . '</label>';
